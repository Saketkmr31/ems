                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                          ...
                          include "../dbcon.php";
                          $a = $_SESSION['assign_to'];
                          $data2 = "select * from assign_leave al join employee el on al.assign_to=el.emp_id where assign_to=$a";
                        ...
                        <tr class="table-info">
                         ...
                         <td><?php echo $result4['f_name']; ?> <?php echo $result4['l_name']; ?></td>
                         <?php
                         ...
                         <td><?php echo $result6['f_name'];?> <?php echo $result6['l_name'];?></td>
                          <td class="text-center">
                            <a href="apply_leave.php?id=<?php echo $result4['id']?>" class="btn btn-info btn2" style = "margin-bottom: 5px;">Apply Leave</a><br>
                          </td>
                        </tr>
                          <?php
                            }
