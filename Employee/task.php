                    ...
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <?php
                          ...
                          $data2 = "select * from assign_task where emp_id = $b";
                        ...
                        <tr class="table-info">
                          <td> <?php echo $i++;?> </td>
                          <td> <?php echo $result4['task']?> </td>
                          <?php
                          $data5 = "select * from assign_task  tl join employee el on tl.assigned_by=el.emp_id";
                          $result5 = mysqli_query($con,$data5);
                          $result6 = mysqli_fetch_array($result5);
                          ?>
                          <td> <?php echo $result6['f_name']?> <?php echo $result6['l_name']?> </td>
                          <td> <?php echo $result4['date_time']?> </td>
                          <td class="text-center">
                            <a href="reply_task.php?id=<?php echo $result4['t_id']?>" class="btn btn-info btn2" style = "margin-bottom: 5px;">View/Reply</a><br>
                          </td>
                        </tr>
                          <?php
                            }
